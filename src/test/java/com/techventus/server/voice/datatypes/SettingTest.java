...
public class SettingTest {
     ...
     */
//    @Test
    //This is a crappy test.  JSON encoding / ordering matters.  We should validate the data in the payload
    // not the raw string generated.  It's failing since ordering isn't the same as the test string.
...
//    @Test
    ...
    public void testGetGroupListAsList() throws JSONException {
        ...
        expectedString = "[testID, testID1]";

        Assert.assertEquals(expectedString, testSetting.getGroupListAsList().toString());
    }
