...
public final class ParsingUtil {
     ...
     * The return includes borders if includeBorders == true - Returns null when Exception occurs
     * Example:
     * removeUninterestingParts("Hello Toby  , How are you today? Fine.", "How are", "?" , <b>true</b>)
     * Returns: "How are you today?"
     * <p>
     * removeUninterestingParts("Hello Joseph, How are you today? Fine.", "How are", "?" , <b>false</b>)
     * Returns: " you today"
     *
     * @param text           the text
     ...
     */
    public static List<String> jsonStringArrayToStringList(JSONObject settingsJSON, List<String> stringList, String key) throws JSONException {
     ...
     * @throws JSONException the jSON exception
     */
    public static List<Integer> jsonIntArrayToIntegerList(JSONObject settingsJSON, List<Integer> integerList, String key) throws JSONException {
     ...
     * @throws JSONException the JSON exception
     */
    public static JSONArray stringListToJsonArray(List<String> stringList) throws JSONException {
        String[] lArray = stringList.toArray(new String[stringList.size()]);
